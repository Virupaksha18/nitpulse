...
function App() {
  return (
    <Router>
      ...
      {/*ece 6th sem notes*/}
      <Route path="/ECE/2022/6th/notes/:subjectSlug"element={<NoteModulesEC6/>}/>
      ...
      <Route path="/lab-programsai1/:subjectSlug"element={<LabProgramDetailsAI1/>}/>
      <Route path="/assignmentsai1/:subjectSlug"element={<AssignmentDetailsAI1/>}/>
