    ...
    <div className="pt-20 px-4 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {subject.assignments.map((item, index) => {
          const pdfUrl = ` ${process.env.REACT_APP_BASE_URL}/files/assignments/ECE/2022/6th/${subjectSlug}/assignment${index + 1}.pdf`;
...
export default AssignmentDetailsEC6;