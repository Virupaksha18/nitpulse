...
const LabProgramDetailsCIVIL3 = () => {
  ...
  const pdfLinks = subject?.programs.map((_, index) => {
    return `${process.env.REACT_APP_BASE_URL}/files/labs/CIVIL/2024/3rd/${subjectSlug}/program${index + 1}.pdf`;
  });
...
export default LabProgramDetailsCIVIL3;