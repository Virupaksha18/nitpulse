...
const LabProgramDetailsCIVIL1 = () => {
  ...
  const pdfLinks = subject?.programs.map((_, index) => {
    return `${process.env.REACT_APP_BASE_URL}/files/labs/CIVIL/2025/1st/${subjectSlug}/program${index + 1}.pdf`;
  });
...
export default LabProgramDetailsCIVIL1;