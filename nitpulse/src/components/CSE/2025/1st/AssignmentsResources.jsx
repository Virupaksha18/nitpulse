...
const assignmentData = {
  ...
  "c": {
    title: "Principle Programming using C",
    assignments: [
    ...
    <div className="pt-20 px-4 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {subject.assignments.map((item, index) => {
          const questionPdf = `${process.env.REACT_APP_BASE_URL}/files/assignments/CSE/2025/1st/${subjectSlug}/assignment${index + 1}_questions.pdf`;
          const solutionPdf = `${process.env.REACT_APP_BASE_URL}/files/assignments/CSE/2025/1st/${subjectSlug}/assignment${index + 1}_solutions.pdf`;
