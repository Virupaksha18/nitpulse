...
const labSubjects = [
 { name: "Data Srtucture Lab", code: "BCSL305",slug:"dsa-lab" },
    { name: "Digital Design and Computer Organisation", code: "BCSL302",slug:"ddco-lab" },
    { name: "Data Analytics with Excel", code: "BCS358A",slug:"excel" },
];
    ...
    <div className="pt-20 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {labSubjects.map((subject, index) => (
          <Link
            key={index}
            to={`/lab-programscs3/${subject.slug}`}
