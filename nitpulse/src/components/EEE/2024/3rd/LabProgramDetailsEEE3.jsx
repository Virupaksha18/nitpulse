...
const LabProgramDetailsEEE3 = () => {
  ...
  const pdfLinks = subject?.programs.map((_, index) => {
    return `${process.env.REACT_APP_BASE_URL}/files/labs/EEE/2024/3rd/${subjectSlug}/program${index + 1}.pdf`;
  });
...
export default LabProgramDetailsEEE3;