...
const LabProgramDetailsEEE5 = () => {
  ...
  const pdfLinks = subject?.programs.map((_, index) => {
    return `${process.env.REACT_APP_BASE_URL}/files/labs/EEE/2023/5th/${subjectSlug}/program${index + 1}.pdf`;
  });
...
export default LabProgramDetailsEEE5;