    ...
    <h1 className="text-3xl font-extrabold text-center">Select your Branch </h1>
      ...
      <div className="text-center mb-8">
        <button
          ...
          className="bg-white px-16 py-8 rounded-2xl shadow-md text-center border hover:border-green-500 hover:shadow-xl"
 ...
 {/* Add Resource Button as teacher */}
      <div className="text-center mb-16">
        <button
          ...
          className="bg-white px-16 py-8 rounded-2xl shadow-md text-center border hover:border-red-500 hover:shadow-xl"
