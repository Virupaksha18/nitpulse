        ...
        <div className="max-w-3xl mx-auto mb-20 bg-white p-8 rounded-3xl shadow-xl border">
          ...
          <form className="space-y-6" onSubmit={teacherhandleSubmit}>
            ...
            <div>
              ...
              <input type="text" name="teacherId" value={teacherformData.teacherId} onChange={teacherhandleChange} className="w-full p-3 border rounded-xl" placeholder="Teacher Id" />
            </div>
